...
r2(temp.cand.models[[1]])
r2(temp.cand.models[[2]])
r2(temp.cand.models[[3]])
r2(temp.cand.models[[4]])
r2(temp.cand.models[[5]])
r2(temp.cand.models[[6]])
r2(temp.cand.models[[7]])
r2(temp.cand.models[[8]])
r2(temp.cand.models[[9]])
r2(temp.cand.models[[10]])
r2(temp.cand.models[[11]])
r2(temp.cand.models[[12]])
r2(temp.cand.models[[13]])
r2(temp.cand.models[[14]])
r2(temp.cand.models[[15]])


check_collinearity(temp.cand.models[[1]])
summary(temp.cand.models[[4]])
confint(temp.cand.models[[4]])
# write.csv(aic_table, file = "../temperature/aic_table.csv")
```

Ultimately, the best model includes Pool ID as a random effect, and depth and shading as fixed effects.
...
r2(min.cand.models[[2]])
r2(min.cand.models[[3]])
r2(min.cand.models[[4]])
r2(min.cand.models[[5]])
r2(min.cand.models[[6]])
r2(min.cand.models[[7]])
r2(min.cand.models[[8]])
r2(min.cand.models[[9]])
r2(min.cand.models[[10]])
r2(min.cand.models[[11]])
r2(min.cand.models[[12]])
r2(min.cand.models[[13]])
r2(min.cand.models[[14]])


summary(min.cand.models[[1]])
confint(min.cand.models[[1]])
```
...
r2(cv.cand.models[[8]])
r2(cv.cand.models[[9]])
r2(cv.cand.models[[10]])
r2(cv.cand.models[[11]])
r2(cv.cand.models[[12]])
r2(cv.cand.models[[13]])
r2(cv.cand.models[[14]])
r2(cv.cand.models[[15]])


summary(cv.cand.models[[4]])
confint(cv.cand.models[[4]])
```
