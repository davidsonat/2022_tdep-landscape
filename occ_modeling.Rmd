...
Mosquito occurrence correlates with pool volume, surface area, depth, and temperature. Meanwhile, dragonfly occurrence correlates with volume, surface area, depth, dist to river channel, and shading
...
```{r, echo = FALSE}
names(occupancy.df)[names(occupancy.df) == 'Temp_Zscore'] <- 'Temp_Z'
occupancy.df$DistRC_Z <- (occupancy.df$DistRC_m - mean(occupancy.df$DistRC_m))/sd(occupancy.df$DistRC_m)
occupancy.df$SurfArea_Z <- (occupancy.df$SurfArea_cm2 - mean(occupancy.df$SurfArea_cm2))/sd(occupancy.df$SurfArea_cm2)

occupancy.df <- subset(occupancy.df, select = c("Pool_ID", "JulianDate", "mosq_a", "mosq_b", "mosq_c", "mosq_d", "dfly_a", "dfly_b", "dfly_c", "dfly_d", "Temp_Z", "DistRC_Z", "SurfArea_Z",  "Temp_Predicted_C", "DistRC_m", "SurfArea_cm2"))
```
...
siteCovs <- as.data.frame(occupancy.df[c(1:2, 11:16)])
...
# Full model
stateformulas <- c('~Temp_Z * SurfArea_Z', '~DistRC_Z + SurfArea_Z', '~Temp_Z * SurfArea_Z + DistRC_Z')
...
stateformulas <- c('~Temp_Z', '~DistRC_Z + SurfArea_Z', '~Temp_Z + SurfArea_Z + DistRC_Z')
detformulas <- c('~JulianDate', '~JulianDate')
...
stateformulas <- c('~Temp_Z', '~SurfArea_Z', '~Temp_Z + SurfArea_Z')
detformulas <- c('~JulianDate', '~JulianDate')
...
stateformulas <- c('~SurfArea_Z', '~DistRC_Z + SurfArea_Z', '~SurfArea_Z + DistRC_Z')
detformulas <- c('~JulianDate', '~JulianDate')
...
stateformulas <- c('~SurfArea_Z', '~DistRC_Z', '~SurfArea_Z + DistRC_Z')
detformulas <- c('~JulianDate', '~JulianDate')
...
stateformulas <- c('~SurfArea_Z', '~SurfArea_Z', '~SurfArea_Z')
detformulas <- c('~JulianDate', '~JulianDate')
...
stateformulas <- c('~SurfArea_Z', '~1', '~SurfArea_Z')
detformulas <- c('~JulianDate', '~JulianDate')
...
stateformulas <- c('~1', '~DistRC_Z + SurfArea_Z', '~SurfArea_Z + DistRC_Z')
detformulas <- c('~JulianDate', '~JulianDate')
...
stateformulas <- c('~1', '~SurfArea_Z', '~SurfArea_Z')
detformulas <- c('~JulianDate', '~JulianDate')
...
# Drop SurfArea_Z from dragon model
...
## Drop SA from mosquitoes and overlap models
stateformulas <- c('~Temp_Z', '~DistRC_Z + SurfArea_Z', '~1')
detformulas <- c('~JulianDate', '~JulianDate')
...
# Drop SA from mosquitoes and RC from dragons
stateformulas <- c('~Temp_Z', '~SurfArea_Z', '~1')
detformulas <- c('~JulianDate', '~JulianDate')
...
## Drop temperature from the mosquito and overlap models
stateformulas <- c('~SurfArea_Z', '~DistRC_Z + SurfArea_Z', '~1')
detformulas <- c('~JulianDate', '~JulianDate')
...
# Drop SA from dragons
stateformulas <- c('~SurfArea_Z', '~DistRC_Z', '~1')
detformulas <- c('~JulianDate', '~JulianDate')
...
# Drop DistRC_Z from dragons
stateformulas <- c('~SurfArea_Z', '~SurfArea_Z', '~1')
detformulas <- c('~JulianDate', '~JulianDate')
...
# Drop both from dragons
stateformulas <- c('~SurfArea_Z', '~1', '~1')
detformulas <- c('~JulianDate', '~JulianDate')
...
## Drop both terms from mosquito and overlap model
stateformulas <- c('~1', '~DistRC_Z + SurfArea_Z', '~1')
detformulas <- c('~JulianDate', '~JulianDate')
...
# Drop DistRC_Z from dragon model
stateformulas <- c('~1', '~SurfArea_Z', '~1')
detformulas <- c('~JulianDate', '~JulianDate')
...
## Drop SA from mosquitoes and overlap models
stateformulas <- c('~Temp_Z', '~DistRC_Z + SurfArea_Z', '~Temp_Z')
detformulas <- c('~JulianDate', '~JulianDate')
...
# Drop SA from mosquitoes and RC from dragons
stateformulas <- c('~Temp_Z', '~SurfArea_Z', '~Temp_Z')
detformulas <- c('~JulianDate', '~JulianDate')
...
## Drop temperature from the mosquito and overlap models
stateformulas <- c('~SurfArea_Z', '~DistRC_Z + SurfArea_Z', '~SurfArea_Z')
detformulas <- c('~JulianDate', '~JulianDate')
...
# Drop SA from dragons
stateformulas <- c('~SurfArea_Z', '~DistRC_Z', '~SurfArea_Z')
detformulas <- c('~JulianDate', '~JulianDate')
...
stateformulas <- c('~Temp_Z', '~DistRC_Z + SurfArea_Z', '~DistRC_Z + SurfArea_Z')
detformulas <- c('~JulianDate', '~JulianDate')
...
# Drop SA from mosquitoes and RC from dragons
stateformulas <- c('~Temp_Z', '~SurfArea_Z', '~SurfArea_Z')
detformulas <- c('~JulianDate', '~JulianDate')
...
stateformulas <- c('~SurfArea_Z', '~DistRC_Z + SurfArea_Z', '~DistRC_Z + SurfArea_Z')
detformulas <- c('~JulianDate', '~JulianDate')
...
# Drop SA from dragons
stateformulas <- c('~SurfArea_Z', '~DistRC_Z', '~DistRC_Z')
detformulas <- c('~JulianDate', '~JulianDate')
...
## Drop both terms from mosquito and overlap model
stateformulas <- c('~1', '~DistRC_Z + SurfArea_Z', '~DistRC_Z + SurfArea_Z')
detformulas <- c('~JulianDate', '~JulianDate')
...
# From the full model
stateformulas <- c('~Temp_Z * SurfArea_Z', '~DistRC_Z + SurfArea_Z', '~Temp_Z * SurfArea_Z')
detformulas <- c('~JulianDate', '~JulianDate')
...
stateformulas <- c('~Temp_Z * SurfArea_Z', '~DistRC_Z + SurfArea_Z', '~Temp_Z + DistRC_Z')
detformulas <- c('~JulianDate', '~JulianDate')
...
stateformulas <- c('~Temp_Z * SurfArea_Z', '~DistRC_Z + SurfArea_Z', '~DistRC_Z + SurfArea_Z')
detformulas <- c('~JulianDate', '~JulianDate')
...
stateformulas <- c('~Temp_Z * SurfArea_Z', '~DistRC_Z + SurfArea_Z', '~SurfArea_Z')
detformulas <- c('~JulianDate', '~JulianDate')
...
stateformulas <- c('~Temp_Z * SurfArea_Z', '~DistRC_Z + SurfArea_Z', '~DistRC_Z')
detformulas <- c('~JulianDate', '~JulianDate')
...
stateformulas <- c('~Temp_Z * SurfArea_Z', '~DistRC_Z + SurfArea_Z', '~Temp_Z')
detformulas <- c('~JulianDate', '~JulianDate')
...
stateformulas <- c('~1', '~DistRC_Z + SurfArea_Z', '~SurfArea_Z')
detformulas <- c('~JulianDate', '~JulianDate')
...
stateformulas <- c('~1', '~DistRC_Z + SurfArea_Z', '~DistRC_Z')
detformulas <- c('~JulianDate', '~JulianDate')
...
stateformulas <- c('~Temp_Z', '~DistRC_Z + SurfArea_Z', '~Temp_Z + SurfArea_Z')
detformulas <- c('~JulianDate', '~JulianDate')
...
stateformulas <- c('~Temp_Z', '~DistRC_Z + SurfArea_Z', '~Temp_Z + DistRC_Z')
detformulas <- c('~JulianDate', '~JulianDate')
...
stateformulas <- c('~Temp_Z', '~DistRC_Z + SurfArea_Z', '~DistRC_Z')
detformulas <- c('~JulianDate', '~JulianDate')
...
stateformulas <- c('~Temp_Z * SurfArea_Z', '~SurfArea_Z', '~Temp_Z')
detformulas <- c('~JulianDate', '~JulianDate')
...
stateformulas <- c('~Temp_Z * SurfArea_Z', '~DistRC_Z', '~Temp_Z + DistRC_Z')
detformulas <- c('~JulianDate', '~JulianDate')
...
stateformulas <- c('~Temp_Z * SurfArea_Z', '~1', '~Temp_Z')
detformulas <- c('~JulianDate', '~JulianDate')
...
stateformulas <- c('~Temp_Z * SurfArea_Z', '~1', '~SurfArea_Z')
detformulas <- c('~JulianDate', '~JulianDate')
...
summary(cand.models[[23]]) # Only includes surface area for dragonflies, which has a positive effect; NaNs produced though
summary(cand.models[[26]]) # Includes temperature for mosquitoes (-, n.s.), surface area for dragonflies (+), temperature for both (+)
summary(cand.models[[53]]) # Includes temperature for mosquitoes (-, n.s.), distance to river channel (-, n.s.) and surface area (+) for dragonflies, and temperature (+) and distance to river channel (-, n.s.) for both
summary(cand.models[[25]]) # This one looks a little funky and has some NaNs for the intercept estimates
summary(cand.models[[22]]) # No predicted for mosquitoes or the intercept, distance to river channel (-, n.s.) and surface area (+) for dragonflies
summary(cand.models[[15]]) # Includes temperature (+, n.s.) for mosquitoes, surface area (+) for dragons, nothing for both
```
...
margin.sp1 <- predict(cand.models[[26]], 'state', species = 1)
mean(margin.sp1[,1]) # 53.6% chance of mosquito occupancy
margin.sp2 <- predict(cand.models[[26]], 'state', species = 2)
mean(margin.sp2[,1]) # 65.7% chance of dragonfly occupancy
margin.sp1sp2 <- predict(cand.models[[26]], 'state', species = c(1, 2))
mean(margin.sp1sp2[,1]) # 19.2% chance that both occur together
...
mean(cond1[,1]) # Only a 29.6% chance of mosquitoes given dragonflies
...
# So if this model is correct, dragons go wherever in the landscape regardless of temperature but seem to occur more often in bigger pools, while mosquitoes seem to occur slightly more often in warmer pools. The presence of dragons reduces the likelihood of mosquitoes being present, but this effect is weaker in warmer pools.
```
...
mosq_plot.df <- as.data.frame(cbind(TempZ.vec, SurfArea.vec))
names(mosq_plot.df) <- c("Temp_Z", "SurfArea_Z")
mosq.predict <- predict(cand.models[[26]], mosq_plot.df, type = 'state', species = 1)
mosq.predict$Temp_C <- mosq_plot.df$Temp_Z * sd(occupancy.df$Temp_Predicted_C) + mean(occupancy.df$Temp_Predicted_C)
...
names(drgn_plot.df) <- c("Temp_Z", "SurfArea_Z")
drgn.predict <- predict(cand.models[[26]], drgn_plot.df, type = 'state', species = 2)
drgn.predict$SurfArea_cm2 <- log(drgn_plot.df$SurfArea_Z * sd(occupancy.df$SurfArea_cm2) + mean(occupancy.df$SurfArea_cm2))


TempZ.vec <- seq(-2.9, 4.0, by = 0.1) # Vector of possible temperature z-scores
SurfArea.vec <- rep(0, length(TempZ.vec)) # Surface area held constant
both_plot.df <- as.data.frame(cbind(TempZ.vec, SurfArea.vec))
names(both_plot.df) <- c("Temp_Z", "SurfArea_Z")
both.predict <- predict(cand.models[[26]], both_plot.df, type = 'state', species = c(1,2))
both.predict$Temp_C <- both_plot.df$Temp_Z * sd(occupancy.df$Temp_Predicted_C) + mean(occupancy.df$Temp_Predicted_C)

ggplot( data = mosq.predict, aes( x = Temp_C, y = Predicted ) ) +
