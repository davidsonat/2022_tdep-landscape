...
int_effect.plot1 <- ggplot(int_effect2, aes(x = x, y = predicted)) +
  ...
  geom_errorbar(aes(ymin = conf.high, ymax = conf.low), width = .2) +
...
Fig5.plot <- plot_grid(int_effect.plot1, int_effect.plot2, legend.plot, ncol = 1, align = c("v"), axis = c("l"), labels = c("a)", "b)", ""), label_x = 0.2, rel_heights = c(1,1,0.15) )


ggsave("../abundance/Fig5.png", plot = Fig5.plot, units = c( "mm" ), dpi = 300, bg = "white" )
```
