...
int_effect.plot <- ggplot( int_effect, aes( MaxTemp, predicted + 1, colour = drgn_presence ) ) +
  geom_line() +
...
ggsave("../abundance/newplot3log.png", plot = int_effect.plot, units = c( "mm" ), dpi = 300, bg = "white" )
```
