...
Fig4.plot <- plot_grid(int_effect.plot1, int_effect.plot2, int_effect.plot3, ncol = 1, align = c("v"), axis = c("l"), labels = c("a)", "b)", "c)" ), label_x = 0.275 )


ggsave("../abundance/Fig4.png", plot = Fig4.plot, units = c( "mm" ), dpi = 300, bg = "white" )
ggsave("../abundance/legend.png", plot = legend.plot, units = c( "mm" ), dpi = 300, bg = "white" )
```
